...
export function createApp(rootDir) {
  ...
  app.get("/api/pnl-image", handlePnlRequest);
  app.post("/api/pnl-image", handlePnlRequest);
  app.get("/api/pnl-image.png", handlePnlRequest);
  app.post("/api/pnl-image.png", handlePnlRequest);
